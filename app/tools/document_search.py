...
_STOPWORDS: Final[frozenset[str]] = frozenset(
    {
        # 疑问词与疑问尾
        "什么", "怎么", "怎样", "如何", "为什么", "哪些", "哪个", "哪里",
        "是否", "多少", "几个", "吗", "呢", "么",
        # 功能词 / 连接词
        "的", "了", "是", "在", "和", "与", "或", "及", "也", "就", "都",
        "会", "能", "要", "有", "无", "被", "把", "对", "从", "到", "为",
        "这个", "那个", "这些", "那些", "一个", "一些", "这里", "那里",
        "可以", "需要", "应该", "必须", "以及", "并且", "但是", "因为",
        "所以", "如果", "那么", "then", "than",
        # 元话语：提问者描述"我在问问题"的措辞，不承载主题
        "问题", "疑问", "请问", "想问", "关于", "相关", "有关",
        "完全", "无关", "完全不", "今天", "昨天", "明天",
        "the", "a", "an", "is", "are", "was", "were", "of", "to", "in",
        "on", "for", "and", "or", "how", "what", "why", "which", "when",
        "does", "do", "did", "it", "its", "this", "that", "these", "those",
        "there", "here", "be", "been", "can", "could", "should", "would",
        "please", "about", "with", "from",
    }
)
